        ...
        <div className="formContainer" style={{marginTop: "12vh"}}>
            ...
            <div className="experienceOption">
                <label style={{ margin: "2vh 0", flexFlow: "column", display: "flex", alignItems: "center", color:selectedScales.includes('1') ? 'black' : 'gray', transition: 'color 0.5s', cursor: "pointer" }}>
                    <input type="checkbox" name="experience" value="1" style={{ display: 'none' }} onChange={() => handleScaleChange('1')}/> <h1 style={{fontSize: "2vh"}}>Pequeña</h1>
                ...
                <label style={{ margin: "2vh 0", flexFlow: "column", display: "flex", alignItems: "center", color:selectedScales.includes('2') ? 'black' : 'gray', transition: 'color 0.5s', cursor: "pointer"}}>
                    <input type="checkbox" name="experience" value="2" style={{ display: 'none' }} onChange={() => handleScaleChange('2')}/> <h1 style={{fontSize: "2vh"}}>Media Baja</h1>
                    <h1 style={{fontSize: "1.37vh"}}>casas, refugios, remodelaciones de oficinas, locales comerciales, etc </h1>
                </label>
                <label style={{ margin: "2vh 0", flexFlow: "column", display: "flex", alignItems: "center", color: selectedScales.includes('3') ? 'black' : 'gray', transition: 'color 0.5s', cursor: "pointer" }}>
                    <input type="checkbox" name="experience" value="3" style={{ display: 'none' }} onChange={() => handleScaleChange('3')}/> <h1 style={{fontSize: "2vh"}}>Media</h1>
                    <h1 style={{fontSize: "1.37vh"}}>conjuntos de casas, edificios pequeños, centros médicos, etc </h1>
                </label>
                <label style={{ margin: "2vh 0", flexFlow: "column", display: "flex", alignItems: "center", color: selectedScales.includes('4') ? 'black' : 'gray', transition: 'color 0.5s', cursor: "pointer" }}>
                    <input type="checkbox" name="experience" value="4" style={{ display: 'none' }} onChange={() => handleScaleChange('4')}/> <h1 style={{fontSize: "2vh"}}>Media Alta</h1>
                    <h1 style={{fontSize: "1.37vh"}}>edificios, clínicas/hospitales, universidades, centros comerciales, etc </h1>
                </label>
                <label style={{ margin: "2vh 0", flexFlow: "column", display: "flex", alignItems: "center", color: selectedScales.includes('5') ? 'black' : 'gray', transition: 'color 0.5s', cursor: "pointer" }}>
                    <input type="checkbox" name="experience" value="5" style={{ display: 'none' }} onChange={() => handleScaleChange('5')}/> <h1 style={{fontSize: "2vh"}}>Gran</h1>
                    <h1 style={{fontSize: "1.37vh"}}>conjuntos de viviendas, parques industriales, planes maestros, etc </h1>
                </label>
            </div>
        </div>
    );
